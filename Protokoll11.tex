...
Bei Messungen von einem RC-Kreis sollte man die \emph{Abfallzeit} vom Oszilloskop berechnen lassen, also die Zeit, die zwischen $90\%$ und $10\%$ der Maximalspannung vergeht\footnote{aus der Anleitung des verwendeten Oszilloskopes}.%Hier muss nochwas eingefügt werden!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
\begin{empheq}[box=\shadowbox*]{align}
	L=(9.6 \pm 0.7)\, \si{\henry} \quad , \quad
	R_L=\left(6.1 \pm 0.5\right)\, \si{\kilo\ohm}
\end{empheq}
Für die Luftspule erhält man:
\begin{empheq}[box=\shadowbox*]{align}
	L=(0.018 \pm 0.001)\, \si{\henry} \quad , \quad
