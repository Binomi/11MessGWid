...
\end{align}
Mit dem Plattenradius $r=0.1~\si{\meter}$, dem Plattenabstand $d=0.005~\si{\meter}$ und einer Plattenzahl $n=65$ unseres Kondensators ergibt sich eine Kapazität $C=3.896~\si{\nano\farad}$.

\begin{align}
	L=\frac{1}{C}\frac{T^2}{4\pi^2+\Lambda^2}
\end{align}
